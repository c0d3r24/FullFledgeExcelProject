...
namespace FullFledgeExcelProject.Controllers
{
    public class ExcelPackageController : Controller
    {
        private readonly IBookRepository _bookRepository;

        public ExcelPackageController(IBookRepository bookRepository)
        {
        ...
        [HttpPost]
        [Route("ExcelPackage/SaveData")]
        public IActionResult SaveData([FromBody]List<BookParam> data)
        {
            foreach (BookParam book in data){
